...
*/route_network ([nav_msgs/Path](http://docs.ros.org/api/nav_msgs/html/msg/Path.html))* - publishing network of all footways<br>
*/shortest_path ([nav_msgs/Path](http://docs.ros.org/api/nav_msgs/html/msg/Path.html))* - publishing found shortest path<br>
*/refused_path ([nav_msgs/Path](http://docs.ros.org/api/nav_msgs/html/msg/Path.html))* -  publishing path, who was localizate obstacles on the road. This path must be refused. Obstacle can be localized by */cancel_point* service<br>
